<!-- start: MAIN NAVIGATION MENU -->
					<ul class="main-navigation-menu">
						<li @if($menu == 'dashboard')class="active open" @endif>
							<a href="/<?php echo \Session::get('logedin_dir'); ?>/dashboard"><i class="clip-home-3"></i>
								<span class="title"> Dashboard </span><span class="selected"></span>
							</a>
						</li>
						<li @if($menu == 'tours')class="active open" @endif>
							<a href="/<?php echo \Session::get('logedin_dir'); ?>/tours"><i class="clip-screen"></i>
								<span class="title"> Tours </span><!--i class="icon-arrow"></i-->
